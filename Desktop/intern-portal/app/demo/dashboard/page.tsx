...
import { DollarSign, Users, Share2, Trophy, Target, TrendingUp, AlertCircle } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Welcome back, {internName}!</h1>
